...
/** Placeholder while week data loads — keeps layout stable and feels faster than a single line of text. */
export function DashboardWeekSkeleton() {
  return (
    <div className="animate-pulse space-y-4" aria-busy="true" aria-label="Loading this week">
